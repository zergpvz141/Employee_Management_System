  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Position</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="homePage.php">Home</a></li>
                <li class="breadcrumb-item"><a href="positionList.php">Position List</a></li>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Position Infomation</h3><br>


                <form method="POST" >
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Position ID </b>(3 digits) <input type="text" name="postID" id="postID" >
                  </li>
                  <li class="list-group-item">
                    <b>Position Name</b> <input type="text" name="postName" id="postName" >
                  </li>
                </ul>
                <li class="list-group">
                  <button  onclick="saveFunction()" name="save" id="save"class="btn btn-success btn-block"><b>Add</b></button>
                  <a href="positionlist.php" onclick="cancelFunction()" id="cancel" class="btn btn-danger btn-block"><b>Cancel</b></a>
                </li>
                </form>
              </div>
              <!-- /.card-body -->
...
$postList= getCheckResultList($con,"SELECT postNo, postName FROM post");
if(isset($_POST['save']) and notEmptyCheck($_POST['postID'],"Position ID")  and notEmptyCheck($_POST['postName'],"Position name") and lengthCheck($_POST['postID'],3) and arrayDuplicateCheck($_POST['postID'],"postNo",$postList) and arrayDuplicateCheck($_POST['postName'],"postName",$postList)) {
  insertDepartment();
}
function insertDepartment()
{
  ...
  $queryString = "INSERT INTO post(postNo,postName) VALUES ('$postID','$postname')";
...
<script>
  ...
  function validateForm() {
    return (arrayDuplicateCheck(document.getElementById('postID').value, "postNo", postList) && arrayDuplicateCheck(document.getElementById('postName').value, "postName", postList)
      && lengthCheck(document.getElementById('postID').value, 3));
  }

          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Project Infomation</h3><br>

                <form method="POST">
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Project Name</b> <input type="text" name="projName" id="projName">
                  </li>
                </ul>
                <li class="list-group">
                  <button onclick="saveFunction()" name="save" id="save"class="btn btn-success btn-block"><b>Add</b></button>
                  <a href="project.php" onclick="cancelFunction()" id="cancel" class="btn btn-danger btn-block"><b>Cancel</b></a>
                </li>
                </form>
              </div>
              <!-- /.card-body -->
...
$projList= getCheckResultList($con,"SELECT projName FROM project");
if(isset($_POST['save'])  and notEmptyCheck($_POST['projName'],"Project name") and arrayDuplicateCheck($_POST['projName'],"projName",$projList)) {
  insertProject();
}
function insertProject()
{
  ...
  $projName = mysqli_real_escape_string($con, $_POST['projName']);
  $start = mysqli_real_escape_string($con, date("Y-m-d"));
  $queryString = "INSERT INTO project (projName,begin_time) VALUES ('$projName','$start')";
//  $leaderQuery = "UPDATE employee SET proNo = '$projName' where empID = '$empID'";
  if (mysqli_query($con, $queryString)) {//and mysqli_query($con, $leaderQuery)

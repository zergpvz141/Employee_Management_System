          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center" id="currentName">Department Name</h3><br>
...
$dptName = $params['dptName'];
$depID = $params['depID'];

$con = mysqli_connect("localhost", "root", "root", "emdb");

$empResult=mysqli_query($con,"SELECT empID FROM employee WHERE depNo = '$depID'");
$empList = array();
while ($empRow = mysqli_fetch_assoc($empResult)) {
  $empList[] = $empRow;
}

$empFullList = getCheckResultList($con,"Select empID FROM employee");
if(isset($_POST['save']) and notEmptyCheck($_POST['empID'],"Employee ID") and arrayDuplicateCheck($_POST['empID'],"empID",$empList) and lengthCheck($_POST['empID'],'3') and arrayNotInCheck($_POST['empID'],"empID",$empFullList)) {
  insertMemeber();
}
function insertMemeber()
{
  ...
  $queryString = "UPDATE employee SET depNo = '$depID' WHERE empID = '$empID'";
...
<script>
  ...
  document.getElementById("cancel").setAttribute("href", "department.php"+depNameUrl(pass_name,pass_id));

...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark" id="currentName">Finance</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="homePage.php">Home</a></li>
                <li class="breadcrumb-item"><a href="departmentList.php">Department List</a></li>
              <li class="breadcrumb-item active" id="navName">Finance</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="DepartmentList" class="table table-bordered table-striped text-center">
                ...
                <a id="add" class="btn btn-primary btn-block"><b>Add Employee in Department</b></a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
  ...
  <script src="dist/in/department.js"></script>
...
$queryString = "Select e.empID, e.ename,p.postNo, p.postName from employee e, post p, department d where d.depNo = '$depID'and e.depNo = d.depNo and e.postNo = p.postNo ";
...
if(isset($_POST)and array_keys($_POST)[0] != '' and $_POST[array_keys($_POST)[1]] =="delete"){
  ...
  $deletePersonDep = "UPDATE employee SET depNo = '013' WHERE empID = '$deleteID'";
...
<div style="display: none;"><?php var_dump( $data ); ?></div>
  ...
  setCurrentName();
  function Dpt_EmployeeContent(_name){
    ...
    document.getElementById("add").setAttribute("href", "addMemberInDepartment.php"+depNameUrl(pass_name,pass_id));
    ...
    for(var i=0; i<alphabet.length; i++){
      ...
      x3.setAttribute("href", "position.php"+pass_postName);
      x3.appendChild(t3);
  ...
  Dpt_EmployeeContent("employeeListBody");
  </script>
  </body>
  </html>

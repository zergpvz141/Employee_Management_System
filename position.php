...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark" id="currentName">General Staff</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="homePage.php">Home</a></li>
                <li class="breadcrumb-item"><a href="positionlist.php">Position List</a></li>
              <li class="breadcrumb-item active" id="navName">General Staff</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="DepartmentList" class="table table-bordered table-striped text-center">
                ...
                <a  id="add" class="btn btn-primary btn-block"><b>Add Employee in Position</b></a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
  ...
  <script src="dist/in/position.js"></script>
...
$queryString = "Select e.empID, e.ename,d.depNo, d.depName from employee e, department d where e.postNo = '$postNo' and e.depNo = d.depNo;";
...
if(isset($_POST)and array_keys($_POST)[0] != '' and $_POST[array_keys($_POST)[1]] =="delete"){
  ...
  $deletePersonDep = "UPDATE employee SET postNo = '015' WHERE empID = '$deleteID'";
  if (mysqli_query($con, $deletePersonDep)) {
...
function employeeDepartment(_name){
  ...
  document.getElementById("add").setAttribute("href", "addMemberInPosition.php"+postNameUrl(pass_name,pass_id));
  ...
  for(var i=0; i<alphabet.length; i++){
    ...
    var v3 = alphabet[i].depNo;
    var v4 = alphabet[i].depName;

    var pass_personName = personNameUrl(v2,v1);
    var pass_depName = depNameUrl(v4,v3);
    ...
    var t3 = document.createTextNode(v4);

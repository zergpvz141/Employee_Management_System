      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a  onclick="cancelFunction()" herf="#" id="navName">Position Name</a></li>
        ...
        <div class="col-md-8">
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              ...
              <h3 class="profile-username text-center" id="currentName">Position Name</h3><br>
...
$resultList = getCheckResultList($con,"Select empID FROM employee WHERE postNo =$postNo");
$empList = getCheckResultList($con,"Select empID FROM employee");

if(isset($_POST['save']) and lengthCheck($_POST['empID'],3) and notEmptyCheck($_POST['empID'],"Employee ID") and arrayDuplicateCheck($_POST['empID'],"empID",$resultList) and arrayNotInCheck($_POST['empID'],"empID",$empList)) {
  insertDepartment();
}
function insertDepartment()
{
  ...
  $queryString = "UPDATE employee SET postNo = '$postNo' WHERE empID = '$empID'";
...
<script>
  ...
  document.getElementById("cancel").setAttribute("href", "position.php"+postNameUrl(pass_name,pass_id));
